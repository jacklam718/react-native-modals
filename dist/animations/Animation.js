...
function Animation(){var toValue=arguments.length>0&&arguments[0]!==undefined?arguments[0]:0;_classCallCheck(this,Animation);
this.animate=new _reactNative.Animated.Value(toValue);
